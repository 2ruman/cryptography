...
//JNIEXPORT jint JNICALL Java_kr_or_kisa_seed_sha256_SHA256_sha256Update(JNIEnv* , jobject , jlongArray , jintArray , jintArray , jbyteArray , jbyteArray , jint , jint );
//JNIEXPORT jint JNICALL Java_kr_or_kisa_seed_sha256_SHA256_sha256Final(JNIEnv* , jobject , jlongArray , jintArray , jintArray , jbyteArray , jbyteArray );
